...
const uint64_t MAX_CAPACITY = 10000;
...
void US::logWood() {
    ...
    void *mem;
    posix_memalign(&mem, 64, sizeof(Wood));
	Wood *woodToFillSilo = (Wood*)mem;
...
void US::pumpOil() {
    ...
    void *mem;
    posix_memalign(&mem, 64, sizeof(Oil));
	Oil *oilToFillBarrel = (Oil*)mem;
...
void US::bakeGoods() {
    ...
    void *mem;
    posix_memalign(&mem, 64, sizeof(Goods));
	Goods *goodsToFillBox = (Goods*)mem;
...
void Canada::milkTrees() {
    ...
    void *mem;
    posix_memalign(&mem, 64, sizeof(MapleSyrup));
    MapleSyrup *syrupToFillBarrel = (MapleSyrup*)mem;
...
void Mexico::produceVanilla() {
    ...
    void *mem;
    posix_memalign(&mem, 64, sizeof(Vanilla));
    Vanilla *vanillaToFillBarrel = (Vanilla*)mem;
...
void Mexico::bakeTortillas() {
    ...
    void *mem;
    posix_memalign(&mem, 64, sizeof(Tortillas));
    Tortillas *tortillasToFillSilo = (Tortillas*)mem;
...
void Mexico::manufactureCars() {
    ...
    void *mem;
    posix_memalign(&mem, 64, sizeof(Cars));
    Cars *carsToFillPallet = (Cars*)mem;
...
int main() {
    void *mem1;
    posix_memalign(&mem1, 64, sizeof(US));
    US *instanceOfUS = (US*)mem1;

    void *mem2;
    posix_memalign(&mem2, 64, sizeof(Canada));
    Canada *instanceOfCanada = (Canada*)mem2;
	
    void *mem3;
    posix_memalign(&mem3, 64, sizeof(Mexico));
    Mexico *instanceOfMexico = (Mexico*)mem3;
